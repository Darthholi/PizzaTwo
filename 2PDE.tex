...
(a do $Z$), platí (pro podposloupnost) $u^{n}\rightarrow u$ v $Y$
(a v $Z$; to je d\r{u}le¸ité k tomu, ¸e limita v t\v{e}chto prostorech
existuje):
\[
...
spojitý v $d$ jako sou\v{c}et spojitých funkcí. Prost\v{e} Caratheodoryova
v\v{e}ta.
\begin{eqnarray*}
