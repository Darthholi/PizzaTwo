...
derivacích a ideáln\v{e} kvadrátech. K tomuhle tvaru se n\v{e}kolikrát
vracíme a v¸dy z n\v{e}j vyvodíme jiné záv\v{e}ry a odhady. Toti¸
libovolný \v{c}len na levé stran\v{e} je men¨í ne¸ pravá strana a
z toho dostanu vícero podmínek na prostor. Typov\v{e} dostávám:
...
\end{eqnarray*}
Kdy¸ mám navíc Neumannova data na hranici, tak ty vypadnou do slabého
\v{r}e¨ení pou¸itím perpartes.
\item Faedo Galerkinova aproximace - sestrojit $u^{n}$ jako bázi $W_{0}^{1,2}$.
Kdy¸ nemáme homogenního dirichleta, tak musíme sestrojovat bázi tro¨ku
jinak - p\v{r}idat k ní konstantní funkci. 
\item Uniformí odhady $u^{n}$ - pou¸ívají se odvozené apriorní odhady.
...
\begin{comment}
myslím si, ¸e postup bude v podstat\v{e} stejný jako u lineární rovnice,
jen je pot\v{r}eba upravit int\_omega arctg (u\textasciicircum{}n)
u\_t\textasciicircum{}n \textless{}= Pi/2.int\_omega Iu\textasciicircum{}n\_tI\textless{}=
...
standardn\v{e} \textless{}u\textasciicircum{}n\_tt,u\textasciicircum{}n,t\textgreater{}
= 1/2 d/dt IIu\textasciicircum{}n\_tII\_2\textasciicircum{}2, u A
pou¸iju elipticitu (snadno lze ov\v{e}\v{r}it ¸e A je eliptická :-)).
Na to lze u¸ vypustit Gronwalla stejn\v{e} jako u lineární rovnice.
A asi je je¨t\v{e} pot\v{r}eba u konvergence nezapomenout od\r{u}vodnit,
¸e arctan(u\textasciicircum{}n)-\textgreater{}arctan(u), co¸ by nem\v{e}l
být problém proto¸e arctan je spojitý a omezený konstantou (viz postup
na minulém cvi\v{c}ení, ten p\v{r}íklad se sinem).
\end{comment}
...
Jsme hyperbolická rovnice, tak¸e testujeme $u_{t}$.
\begin{align*}
\int_{\Omega}u_{tt}u_{t}\, dx+\int_{\Omega}A\nabla u\nabla u_{t}\, dx+\int_{\Omega}\arctan(u)u_{t}\, dx & =\int_{\Omega}fu_{t}\, dx
\end{align*}


První \v{c}len zapí¨eme trikem s derivací kvadrátu, druhý \v{c}len,
rozd\v{e}líme na dva vytknutím \v{c}asové derivace:
...
V na¨em p\v{r}ípad\v{e} je matice $A$ konstantní, tak¸e t\v{r}etí
\v{c}len vymizí, jinak bychom ji ¨oupli na pravou stranu. \v{c}len
s arctg dáme na pravou stranu:
